...
interface HomeDetailAction {
    ...
    data class OnReviewDeleteClicked(val reviewId: Long, val animeId: Long) : HomeDetailAction
    data class OnReviewReportClicked(val reviewId: Long, val animeId: Long) : HomeDetailAction
    data class OnUserBlockClicked(val userId: Long, val animeId: Long) : HomeDetailAction

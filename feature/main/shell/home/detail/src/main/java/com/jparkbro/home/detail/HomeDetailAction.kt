...
interface HomeDetailAction {
    ...
    data class OnReviewLikeClicked(val reviewId: Long, val isLiked: Boolean, val callback: (Boolean) -> Unit) : HomeDetailAction
    ...
    data class NavigateToEditReview(val animeId: Long, val reviewId: Long, val type: FormType) : HomeDetailAction
